...
OWNER_USERNAME = getenv("OWNER_USERNAME","Hopeless_Boy")
...
OWNER_ID = int(getenv("OWNER_ID", 6536952975))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/hopeless_boy")
